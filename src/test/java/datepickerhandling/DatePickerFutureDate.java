...
public class DatePickerFutureDate {
	...
	public static void main(String[] args) {
		...
		// Approach1: for future date - Inserting month, date, year (mm/dd/yyyy) directly into the input box
		
	//	driver.findElement(By.xpath("//input[@id='datepicker']")).sendKeys("01/27/2024");
		
		
		// Approach2:
		
		// For future date (expected dates)
		...
		while(true)
	{
		...
		{
		  driver.findElement(By.xpath("//span[@class='ui-icon ui-icon-circle-triangle-e']")).click(); // clicking front arrow
		}
