...
public class FixedDepositCalculator {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String file = System.getProperty("user.dir")+"\\Testdata\\Calcdata.xlsx"; // to open excel file in a reading mode and capture the file location

		int rows = ExcelUtils.getRowCount(file, "sheet1"); // capture the row or call getrowcount method from excelutils
